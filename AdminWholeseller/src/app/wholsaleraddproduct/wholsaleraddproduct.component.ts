...
@Component({
  selector: 'app-wholsaleraddproduct',
  templateUrl: './wholsaleraddproduct.component.html',
  styleUrls: ['./wholsaleraddproduct.component.css']
})
export class WholsaleraddproductComponent implements OnInit {
  ...
  constructor(private _service:CategoryService,
    ...
    onAdd(){
      ...
      this._wholesalerser.addWholesalerProduct(fd).subscribe(
          (data:any)=>{
            console.log(fd);
            this.tempproarr.push(new product(this.product_id,'../../assets/'+this.product_img+'.jpg',this.fk_cat_id,this.fk_brand_id,this.product_qty,this.product_size,this.product_color,this.product_price,this.fk_user_id,this.date));
            alert("Added");
            console.log(data);
          }
       );
